...
const SERVICES = [
  { icon: '🔐', title: 'Data Destruction',        href: '/services/data-destruction', accent: 'red-accent',   bg: 'red-bg',   desc: 'Following NIST 800-88 guidelines. Physical shredding and software overwrite. Certificates issued per device.' },
